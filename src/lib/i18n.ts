...
const translations = {
  en: {
    ...
    wellness: {
      ...
      steps: {
        title: '10k steps',
        subtitle: (goal: number) => `Daily target: ${goal.toLocaleString()} steps. Weekly/monthly history is shown below.`,
  ...
  he: {
    ...
    wellness: {
      ...
      steps: {
        title: '10k צעדים',
        subtitle: (goal: number) => `יעד יומי: ${goal.toLocaleString()} צעדים. ההיסטוריה השבועית/חודשית מוצגת למטה.`,
