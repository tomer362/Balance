...
const translations = {
  en: {
    ...
    cheatMeals: {
      ...
      quickTickPrompt: 'Did you have a cheat meal today?',
      quickTickDone: 'Cheat meal logged today ✓',
      quickTickRemove: 'Tap to remove',
      ...
      catalogueTitle: 'Pick a meal from the catalogue',
      catalogueSearch: 'Search meals...',
      customEntry: 'Custom / type your own',
      mealsTab: 'Full meals',
      ingredientsTab: 'Ingredients',
      ingredientSearch: 'Search ingredients...',
      ingredientBasketEmpty: 'Search and add ingredients to build your cheat meal.',
      noResults: 'No results found.',
      ingredientAmountLabel: 'g',
      basketTotal: 'Total',
      defaultCheatName: 'Custom cheat meal',
      nutritionSummary: (kcal: number, protein: number) => `${kcal} kcal · ${protein}g protein`,
    ...
    wellness: {
      ...
      workouts: {
        ...
        goalValue: (goal: number) => `${goal} workout${goal === 1 ? '' : 's'} / week`,
        editGoal: 'Edit workout goal',
      ...
      notifications: {
        title: 'Notifications',
        subtitle: 'Browser reminders for weight, water, food, and steps.',
  ...
  he: {
    ...
    cheatMeals: {
      ...
      quickTickPrompt: 'האם היתה לך ארוחת צ׳יט היום?',
      quickTickDone: 'ארוחת צ׳יט נרשמה היום ✓',
      quickTickRemove: 'לחץ להסרה',
      ...
      addNutritionDetails: 'הוסף פרטי תזונה',
      catalogueTitle: 'בחר ארוחה מהקטלוג',
      catalogueSearch: 'חיפוש ארוחות...',
      customEntry: 'מותאם אישית / הקלד בעצמך',
      mealsTab: 'ארוחות מלאות',
      ingredientsTab: 'מרכיבים',
      ingredientSearch: 'חיפוש מרכיבים...',
      ingredientBasketEmpty: 'חפשו והוסיפו מרכיבים לבניית ארוחת הצ׳יט שלכם.',
      noResults: 'לא נמצאו תוצאות.',
      ingredientAmountLabel: 'ג׳',
      basketTotal: 'סה״כ',
      defaultCheatName: 'ארוחת צ׳יט מותאמת אישית',
      nutritionSummary: (kcal: number, protein: number) => `${kcal} קק״ל · ${protein}ג׳ חלבון`,
      currentWeek: 'השבוע',
      history: 'היסטוריה',
    ...
    wellness: {
      ...
      workouts: {
        ...
        goalValue: (goal: number) => `${goal} אימונים בשבוע`,
        editGoal: 'עריכת יעד אימונים',
      ...
      notifications: {
        title: 'התראות',
        subtitle: 'תזכורות דפדפן למשקל, מים, אוכל וצעדים.',
        request: 'אישור התראות',
