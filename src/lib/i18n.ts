...
const translations = {
  en: {
    ...
    dashboard: {
      ...
      quickLogTitle: 'Quick logging',
      quickLogSubtitle: 'Shortcuts to every place where you log meals, ingredients, and weight.',
      shortcuts: {
        meals: 'Log meals consumed',
        ingredients: 'Log ingredients consumed',
        logWeight: 'Log weight',
        weightHistory: 'View weight history',
      },
      goal: 'goal',
  ...
  he: {
    ...
    dashboard: {
      ...
      quickLogTitle: 'רישום מהיר',
      quickLogSubtitle: 'קיצורי דרך לכל מקום שבו רושמים ארוחות, מרכיבים ומשקל.',
      shortcuts: {
        meals: 'רישום ארוחות שנאכלו',
        ingredients: 'רישום מרכיבים שנצרכו',
